...
# ── Database ────────────────────────────────────────────────────────────────────
# Uses SQLite locally, can be swapped for PostgreSQL on Render
DATABASES = {
    'default': {
...
CORS_ALLOWED_ORIGINS = [
    'http://localhost:3000',
    'http://127.0.0.1:3000',
    # Add your Vercel URL below after deploying frontend
    # 'https://smart-job-tracker.vercel.app',
]

# Also allow all Render + Vercel subdomains
